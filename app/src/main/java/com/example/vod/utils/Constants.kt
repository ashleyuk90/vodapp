...
object Constants {
    ...
    const val KEY_LAST_UPDATE_CHECK_MS = "KEY_LAST_UPDATE_CHECK_MS"
    const val KEY_SKIPPED_UPDATE_VERSION_CODE = "KEY_SKIPPED_UPDATE_VERSION_CODE"
    const val KEY_PENDING_UPDATE_APK_PATH = "KEY_PENDING_UPDATE_APK_PATH"
    const val KEY_PENDING_UPDATE_VERSION_CODE = "KEY_PENDING_UPDATE_VERSION_CODE"
    const val KEY_AVAILABLE_UPDATE_VERSION_CODE = "KEY_AVAILABLE_UPDATE_VERSION_CODE"
}
